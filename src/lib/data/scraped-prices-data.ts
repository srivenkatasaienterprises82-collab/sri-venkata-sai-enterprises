...
export const SCRAPED_PRICES_BY_SLUG: Record<string, ScrapedPriceEntry> = {
  "vivo-v70-elite": {
    "colorNames": [
      "Authentic Black",
      "Passion Red",
  ...
  "moto-g96": {
    "colorNames": [
      "Pantone Cattleya Orchid",
      "Pantone Dresden Blue",
