...
async function seedHomePage(): Promise<void> {
  ...
  const doc = {
    _id: "homePage",
    _type: "homePage",
    heroTitle: `${siteConfig.storeShortName} — Your Trusted Mobile Store in ${siteConfig.address.city}`,
...
const BANNERS = [
  {
    ...
    image: "https://via.placeholder.com/1200x600/1a1a2e/ffffff?text=iQOO+15R",
  ...
  },
  {
    ...
    image: "https://via.placeholder.com/1200x600/0d2137/ffffff?text=Motorola+Edge+70+Pro",
  ...
  },
  {
    ...
    image: "https://via.placeholder.com/1200x600/1c1c1e/ffffff?text=iPhone+17+Series",
  ...
  },
  {
    ...
    image: "https://via.placeholder.com/1200x600/2d1b69/ffffff?text=iQOO+Neo+10+Pro",
    link: "/products?brand=iqoo",
    active: true,
    order: 4,
  },
